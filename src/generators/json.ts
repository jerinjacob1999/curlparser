...
function repr (value:string, isKey:boolean =false):string {
...
const toJsonString = (curlCommand:string) => {
  
  const request:requestInterface = parseCurlCommand(curlCommand)

  let requestJson ={} as requestJson
